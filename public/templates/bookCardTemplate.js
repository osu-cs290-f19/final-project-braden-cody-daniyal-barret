...
templates['bookCard'] = template({"compiler":[8,">= 4.3.0"],"main":function(container,depth0,helpers,partials,data) {
  ...
  return "<div class=\"col s12 m4 l4 books\">\r\n    <div class=\"card\" data-id="
    ...
    + "' target=\"_blank\" class='waves-effect, action-buttons'><i class=\"material-icons\">add_shopping_cart</i></a>\r\n            <a href='#!' class=\"waves-effect, action-buttons\" id='edit-button'><i class='material-icons'>edit</i></a>\r\n            <a href='#!' class='waves-effect, favorite-button, action-buttons' style=\"float: right\"><i class='material-icons'>favorite</i></a>\r\n        </div>\r\n    </div>\r\n</div>\r\n";
},"useData":true});
})();